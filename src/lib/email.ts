...
<body style="margin:0;padding:0;background:#08090b;font-family:Inter,Helvetica,Arial,sans-serif;color:#f5f6f8;">
  <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:#08090b;padding:32px 16px;">
    <tr><td align="center">
      <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:560px;background:#16181c;border:1px solid rgba(255,255,255,0.09);border-radius:14px;overflow:hidden;">
        <tr><td style="padding:28px 32px 8px;">
          <div style="font-size:15px;font-weight:800;letter-spacing:.03em;color:#ffc75f;">LEUNAME SOFTWARE</div>
        </td></tr>
        <tr><td style="padding:8px 32px 0;">
          <h1 style="margin:0 0 12px;font-size:22px;line-height:1.25;color:#f5f6f8;">¡Gracias por tu compra${
        ...
        <tr><td style="padding:16px 32px 28px;">
          ...
          <p style="margin:0;font-size:12.5px;line-height:1.6;color:#a3a8b3;">
            ...
            <a href="mailto:${siteConfig.supportEmail}" style="color:#ffc75f;">${siteConfig.supportEmail}</a>.
          </p>
        </td></tr>
