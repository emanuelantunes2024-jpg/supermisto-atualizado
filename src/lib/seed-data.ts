...
const seed: SeedTemplate[] = [
  ...
  },
  {
    ...
    short_description: "Alta cocina: carta interactiva, reserva de mesa y eventos privados.",
    full_description:
  ...
  },
  {
    id: `${TPL}17`,
    categorySlug: "restaurantes",
    title: "Bistró del Barrio",
    slug: "bistro-del-barrio",
    short_description: "Restaurante de barrio con menú del día, carta y reserva de mesa.",
    full_description:
    ...
    price_cents: 12900,
    preview_url: null,
    gradient: "linear-gradient(160deg,#20160c,#3a2a18 55%,#140e08)",
    features: [
      "Menú del día actualizable cada semana",
