...
const seed: SeedTemplate[] = [
  {
    ...
    short_description: "Clínica dental con 10 especialidades, cita online y financiación sin intereses.",
    full_description:
      "Para clínicas dentales y consultas privadas: diez áreas de especialización con icono propio (implantes, ortodoncia, blanqueamiento, endodoncia, odontopediatría...), foto de portada y de equipo, proceso de trabajo en cuatro pasos, cifras de la clínica, opiniones de pacientes, blog y formulario de cita con validación. Tipografía Playfair Display. Los colores de marca (acento y fondo oscuro) se cambian con un selector desde el propio panel, sin tocar código: todo el sitio se actualiza al instante.",
    price_cents: 22900,
    preview_url: "/demos/clinica-dental-premium/index.html",
    gradient: "linear-gradient(160deg,#0a1f2b,#1e313c 55%,#0a1f2b)",
    features: [
  ...
  },
  {
    ...
    gradient: "linear-gradient(160deg,#0d0d0d,#2b1414 55%,#0d0d0d)",
    features: [
