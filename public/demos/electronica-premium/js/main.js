...
(function () {
  ...
  var LLAVE    = 'electromax_carrito';
  var LLAVE_FAV = 'electromax_favoritos';
  ...
  function pintarFavoritos() {
    [].forEach.call(document.querySelectorAll('.prod-fav'), function (b) {
      var art = b.closest('.prod-card');
      var boton = art ? art.querySelector('[data-anadir]') : null;
      var id = boton ? boton.dataset.anadir : null;
