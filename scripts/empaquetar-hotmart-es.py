...
<div class="folha">
  ...
  <section class="bloco">
    ...
    <div class="passos">
      ...
      archivo del producto en Hotmart. Contiene el <code>index.html</code> y las carpetas <code>css/</code>,
      <code>js/</code> e <code>img/</code> por separado.</p></div>
    </div>
  </section>
  ...
  <section class="bloco">
    <div class="bloco-cab"><div class="bloco-num">05</div>
      <div><h2>Empaquetar para vender en Hotmart</h2><p>El producto que entregas al comprador.</p></div>
    </div>
    <div class="passos">
      ...
      <code>site-completo/</code> en un nuevo .zip — ese .zip es el que subes como "archivo del producto".</p></div>
